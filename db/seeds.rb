...
courses = [{:name => 'Principles of Economics', :course => 'ECON UN1105 Principles of Economics', :prof => 'Sunil Gulati', :time => 'MW 10:10-11:25', :preReqs => 'None', :description => 'How a market economy determines the relative prices of goods, factors of production, and the allocation of resources and the circumstances under which it does it efficiently. Why such an economy has fluctuations and how they may becontrolled.'},
           ...
           {:name => 'Masterpieces of Western Music', :course => 'HUMA UN1123 Masterpieces of Western Music', :time => 'TTh 11:40-12:55'},
           ...
           {:name => 'Intermediate Microeconomics', :prof => 'Susan Elmes', :course => 'ECON UN3211 Intermediate Microeconomics', :time => 'TTh 6:40-7:55'},
           ...
           {:name => 'Calculus II', :course => 'MATH UN1102 Calculus II', :time => 'TTh 11:40-12:55'},
           ...
           {:course => 'SCNC 1100 Frontiers of Science', :time => 'TTh 8:40-9:55'},
           {:course => 'HUMA CC1001 Masterpieces of Western Literature', :time => 'MW 4:10-5:25'},
           {:course => 'COCI CC1101 Contemporary Western Civilization', :time => 'TTh 1:10-2:25'},
           {:course => 'ECON UN3412 Introduction to Econometrics', :time => 'MW 1:10-2:25'},
           {:course => 'ECON UN3212 Intermediate Macroeconomics', :time => 'TTh 1:10-2:25'},
           {:course => 'COMS 3134 Data Structures in Java', :time => 'MW 4:10-5:25'},
           {:course => 'COMS 3251 Computational Linear Algebra', :time => 'TTh 10:10-11:25'},
           {:course => 'COMS 3261 Computer Science Theory', :time => 'MW 8:40-9:55'},
           {:course => 'COMS 3827 Fundamentals of Computer Systems', :time => 'TTh 4:10-5:25'},
           {:course => 'IEOR E3658 Probability for Engineers', :time => 'TTh 1:10-2:25'},
           {:course => 'IEOR E3106 Stochastic Systems and Applications', :time => 'MW 5:40-6:55'},
           {:course => 'IEOR E3608 Foundations of Optimization', :time => 'TTh 8:40-9:55'},
           {:course => 'IEOR E3404 Simulation Modeling and Analysis', :time => 'MW 8:40-9:55'}
        ]
