...
describe DashboardsController do
    before do
        ...
        courses = [{:name => 'Principles of Economics', :course => 'ECON UN1105 Principles of Economics', :prof => 'Sunil Gulati', :preReqs => 'None', :description => 'How a market economy determines the relative prices of goods, factors of production, and the allocation of resources and the circumstances under which it does it efficiently. Why such an economy has fluctuations and how they may becontrolled.'},
                            ...
                            {:name => 'Masterpieces of Western Music', :course => 'HUMA UN1123 Masterpieces of Western Music', :time => 'MWF'},
                            ...
                            {:name => 'Engineering SaaS', :course => 'COMS 4152 Engineering SaaS', :prof => 'Junfeng Yang', :preReqs => '', :description => '', :time => 'TR'},
        ...
        schedules = [{:uni => 'agh2172', :course => 'COMS 4152 Engineering SaaS'}, {:uni => 'agh2172', :course => 'HUMA UN1123 Masterpieces of Western Music'}]
    ...
    it 'creates proper student schedule' do
      get :show, session: {uni: 'agh2172', pw:'123456'}
      sched = assigns(:schedule)
      expect(sched[1][0].course).to include("COMS 4152 Engineering SaaS")
    end
