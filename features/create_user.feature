...
Scenario: new user adds past courses to database
    ...
    Then there exists a record that "agh2172" took "Advanced Programming" in "Spring" "2021"
    Then there does not exist a record that "agh2172" took "Computer Networks" in "Fall" "2021"
